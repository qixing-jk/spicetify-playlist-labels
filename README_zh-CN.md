...
为您的曲目列表添加播放列表标签，以指明曲目包含在哪些播放列表中。点击标签可跳转至相应播放列表。
...
感谢 [WildGenius](https://github.com/WildGenius) 和 [brimell](https://github.com/brimell) 制作了这些精美的播放列表图片，供希望使用星级评分系统为曲目评分的用户使用！
